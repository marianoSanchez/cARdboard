...
public class ColliderEvents : MonoBehaviour
{
	...
	[HideInInspector]
	public SerializableDelegate				firstInEvent;
	
	[HideInInspector]
	public SerializableDelegate				lastOutEvent;
	
	[HideInInspector]
	public SerializableDelegate				enterEvent;
	
	[HideInInspector]
	public SerializableDelegate				exitEvent;
