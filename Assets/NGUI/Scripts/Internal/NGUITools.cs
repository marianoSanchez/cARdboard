...
static public class NGUITools
{
    ...
    public static List<EventDelegate> onSoundVolumeChange = new List<EventDelegate>();
    ...
    static public float soundVolume
    {
        ...
        set
        {
            if (mGlobalVolume != value)
            {
                ...
                if (EventDelegate.IsValid(onSoundVolumeChange))
                    EventDelegate.Execute(onSoundVolumeChange);
            }
        }
    }
    ...
    static public AudioSource PlaySound(AudioClip clip, float volume) { return PlaySound(clip, volume, 1f, false); }

    /// <summary>
    /// Play the specified audio clip with the specified volume and pitch.
    /// </summary>

    static public AudioSource PlaySound(AudioClip clip, float volume, float pitch) { return PlaySound(clip, volume, 1f, false); }
    ...
    static public AudioSource PlaySound(AudioClip clip, float volume, float pitch, bool looped)
    {
...
#else
                    source = mListener.GetComponent<AudioSource>();
#endif
