...
#       endif // debug warnings
    ...
    /*! This should be a valid IP address (IPv4 or IPv6 format). It will always
     *  be anonymized just as though addAnonymizeIP had been used.
...
#       endif // debug warnings
    ...
    //! (Category:Content Information) Adds screen name. *Required* for GA "Mobile app" tracking properties.
